...
| TD-009 | Questions | Fluxos completos no navegador nao estavam versionados | Blocos, respostas e integracao com Banco de Erros agora possuem cobertura Playwright | Media | Resolvido |
...
| TD-011 | Navigation testing | Ausencia de testes DOM para Sidebar, links ativos e navegacao | Nove rotas, link ativo, menu mobile e foco possuem cobertura cross-browser | Media | Resolvido |
...
| TD-013 | Visual QA | Testes visuais automatizados por breakpoint ainda nao existiam | 53 baselines protegem nove rotas em cinco viewports | Media | Resolvido |
...
| TD-024 | E2E | Playwright nao fazia parte da suite versionada | 123 testes ativos cobrem jornadas, browsers, acessibilidade e regressao visual | Media | Resolvido |
...
| TD-026 | E2E | A suite completa e serial para evitar crashes por pressao de recursos | Gate local e de CI leva aproximadamente 6 a 7 minutos | Baixa | Mitigado |
| TD-027 | Visual QA | Baselines sao dependentes do sistema operacional | CI visual fixado em Windows; migracao de runner exige nova revisao canonica | Baixa | Mitigado |
