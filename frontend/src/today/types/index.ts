...
export interface TodayActivity { id: string; type: TodayActivityType; discipline: string; subject: string; estimatedMinutes: number; priority: TodayPriority; status: TodayActivityStatus; recommendationReason: string; }
