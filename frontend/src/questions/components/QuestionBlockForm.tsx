...
const initialInput: QuestionBlockInput = {
  annulledAnswers: 0, bank: '', correctAnswers: 0, date: new Date().toISOString().slice(0, 10), difficulty: 'medium', discipline: '', durationMinutes: 0, notes: '', platform: '', subject: '', totalQuestions: 0, wrongAnswers: 0,
};
